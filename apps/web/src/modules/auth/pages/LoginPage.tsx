    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse 60% 50% at 30% 20%, rgba(124,106,239,0.06) 0%, transparent 60%), radial-gradient(ellipse 50% 40% at 70% 80%, rgba(54,191,170,0.03) 0%, transparent 60%)",
        }}
      />
      ...
      >
        ...
        >
          {isRegister && (
            <>
              ...
              >
                <Input
                  prefix={
                    <UserOutlined style={{ color: "var(--c-text-dim)" }} />
                  }
          ...
          >
            <Input
              prefix={<MailOutlined style={{ color: "var(--c-text-dim)" }} />}
          ...
          <Form.Item
            ...
            rules={[
              ...
              ...(isRegister ? [{ min: 8, message: "Min 8 chars" }] : []),
            ]}
          >
            <Input.Password
              prefix={<LockOutlined style={{ color: "var(--c-text-dim)" }} />}
        ...
        <Divider
          style={{ borderColor: "var(--c-glass-border)", margin: "16px 0" }}
        >
          <Text
            style={{
              color: "var(--c-text-dim)",
