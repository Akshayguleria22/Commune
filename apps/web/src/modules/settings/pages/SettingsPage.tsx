...
import {
  UserOutlined, SettingOutlined, BellOutlined, BgColorsOutlined,
...
const SettingsPage: React.FC = () => {
              ...
              >
                ...
                <div style={{ textAlign: "left" }}>
                  ...
                  >
                    ...
                    />
                    <Text
                      style={{ color: "var(--c-text-muted)", fontSize: 13 }}
                    >
                      {user?.email}
                    </Text>
                  </div>
                  ...
                  {(user as any)?.website && (
                    ...
                    >
                      ...
                      />
                      <Text
                        style={{ color: "var(--c-accent-soft)", fontSize: 13 }}
                      >
                        {(user as any).website}
                      </Text>
                    </div>
              ...
              {[
                {
                  key: "emailDigest",
                  label: "Email Digest",
                  desc: "Receive a daily summary of activity",
                },
                {
                  key: "pushEvents",
                ...
                },
                {
                  key: "pushMessages",
                  label: "New Messages",
                  desc: "Direct message notifications",
                },
                {
                  key: "pushMentions",
                  label: "Mentions",
                  desc: "When someone mentions you in a task or channel",
                },
                {
                  key: "pushTasks",
                  label: "Task Updates",
                  desc: "Changes to tasks assigned to you",
                },
                {
                  key: "weeklyReport",
                  label: "Weekly Report",
                  desc: "Summary of your community contributions",
                },
              ].map(({ key, label, desc }) => (
                <div
                  key={key}
        ...
        <motion.div variants={fadeUp} initial="hidden" animate="visible">
          ...
          >
            ...
            <Form
              ...
              requiredMark={false}
              onFinish={() =>
                message.info("Password change is not yet supported by the API")
              }
            >
              <Form.Item
              ...
              >
                <Input.Password
                  prefix={
                    <LockOutlined style={{ color: "var(--c-text-dim)" }} />
                  }
            ...
            <Paragraph style={{ color: "var(--c-text-dim)", fontSize: 13 }}>
              Manage your active login sessions. Logging out on other devices
              will require re-authentication.
            </Paragraph>
            <Button
              danger
              onClick={() => message.info("Session management coming soon")}
            >
  ...
  // Force re-render so tabs children are always fresh
    ...
    <div style={{ position: "relative", minHeight: "60vh" }}>
      ...
      <div
        style={{
          ...
          height: 300,
          background:
            "radial-gradient(circle, rgba(124,106,239,0.06) 0%, transparent 60%)",
          filter: "blur(60px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
