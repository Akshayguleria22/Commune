    ...
    <div style={{ position: "relative" }}>
      ...
      {nextEvent && (
        ...
        >
          ...
          />
          <Text
            style={{ color: "var(--c-success)", fontWeight: 600, fontSize: 13 }}
          >
            <ThunderboltOutlined /> Next event{" "}
            {daysUntilNext === 0
              ? "today"
          ...
          <div
            style={{
              ...
              height: 1,
              background:
                "linear-gradient(90deg, rgba(16,185,129,0.3) 0%, transparent 100%)",
            }}
          />
        </div>
      )}
        ...
        <Tabs
          ...
          items={[
            ...
            },
            {
              ...
              label: (
                <span>
                  <ClockCircleOutlined /> Past ({past.length})
                </span>
              ),
              children:
                past.length === 0 ? (
      ...
      >
        <Form
          form={form}
          layout="vertical"
          onFinish={(v) => createEvent.mutate(v)}
          requiredMark={false}
        >
          <Form.Item
            name="communityId"
